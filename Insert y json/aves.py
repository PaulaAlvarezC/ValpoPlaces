...
# ---------------------------- Para insertar json Aves-Valparaiso en la tabla Foto-------------------------------
with open('C:\Users\Pau\Desktop\Final Valckr\Valckr\esvalpo.json') as data_file:
...
for i in range(50):
    ...
    for ins in [(Titulo, Url, Owner, Date, Tags, ID_Tag),
        ...
        Cur.execute(
            'INSERT into directorios_foto (Titulo, Url, Owner, dateupload, Tags, ID_Tag_id)  VALUES (?,?,?,?,?,?)', ins)
